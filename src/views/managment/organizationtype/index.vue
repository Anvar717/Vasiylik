    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'editorganizationtype', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'editorganizationtype', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
            v-if="$can('OrganizationTypeEdit', 'permissions')"
          >
          ...
          <b-link
            ...
            v-if="$can('OrganizationTypeDelete', 'permissions')"
          >
...
export default {
  ...
  methods: {
    Delete(item) {
      ...
      OrganizationTypeService.Delete(item.id)
        .then((res) => {
