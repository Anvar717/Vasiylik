...
export default {
  ...
  created() {
    ...
    this.show = true;
    HrEmpSendTrainService.Get(this.$route.params.id)
      .then((res) => {
        this.show = false;
  ...
  methods: {
    ...
    AddData() {
      ...
      if (this.editedIndex > -1) {
        Object.assign(
          this.HrEmpSendTrain.Tables1[this.editedIndex],
          this.tabrow
        );
      } else {
        this.HrEmpSendTrain.Tables1.push(this.tabrow);
      }
    ...
    DocdateValue(value) {
      this.HrEmpSendTrain.docdate = value;
    },
    EnddateValue(value) {
    ...
    SaveData() {
      HrEmpSendTrainService.Update(this.HrEmpSendTrain)
        .then((res) => {
