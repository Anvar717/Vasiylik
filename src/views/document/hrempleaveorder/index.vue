    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditHREmpLeaveOrder', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditHREmpLeaveOrder', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            v-if="$can('HREmpLeaveOrderEdit', 'permissions') && item.statusid !== 2"
          ...
          <b-link
            ...
            v-if="$can('HREmpLeaveOrderDelete', 'permissions') && item.statusid !== 2"
             style="margin-right: 5px"
          >
            <feather-icon icon="Trash2Icon"></feather-icon>
          </b-link>
          <b-link
            :to="{ name: 'ViewHREmpLeaveOrder', params: { id: item.id } }"
...
export default {
  ...
  methods: {
    ...
    Refresh() {
      this.isBusy = true;
      HREmpLeaveOrderService.GetList(
    ...
    Delete(item) {
      ...
      HREmpLeaveOrderService.Delete(item.id)
        .then((res) => {
