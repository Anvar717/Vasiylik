          ...
          <b-col sm="12" md="8" lg="8">
            ...
            <div class="form-group form-row">
              ...
              <div class="col-sm-7 d-flex align-items-center">
                <p class="m-0 p-0">
                  <b> {{ tabrow.employeeenrolmentid }} </b>
                </p>
              </div>
            </div>
            <div class="form-group form-row">
...
export default {
  ...
  created() {
    ...
    this.show = true;
    HrWorkDayOffService.Get(this.$route.params.id)
      .then((res) => {
        this.show = false;
  ...
  methods: {
    GetpersonPersondata() {
      ...
      EmployeeManageService.GetEmployeeListForComponent(
        (this.filter.OnDate = this.HrWorkDayOff.docdate),
    ...
    PersonChange(item) {
      this.tabrow.personid = item.personids;
    ...
    AddData() {
      ...
      if (this.editedIndex > -1) {
        Object.assign(this.HrWorkDayOff.Tables[this.editedIndex], this.tabrow);
      } else {
        this.HrWorkDayOff.Tables.push(this.tabrow);
      }
    ...
    DocdateValue(value) {
      this.HrWorkDayOff.docdate = value;
    },
    DayoffdateValue(value) {
      this.tabrow.dayoffdate = value;
    },
    Openperson() {
    ...
    SaveData() {
      HrWorkDayOffService.Update(this.HrWorkDayOff)
        .then((res) => {
