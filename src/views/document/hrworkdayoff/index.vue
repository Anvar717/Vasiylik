    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditHrWorkDayOff', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditHrWorkDayOff', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            v-if="$can('HrWorkDayOffEdit', 'permissions') && item.statusid !== 2"
          ...
          <b-link
            ...
            v-if="$can('HrWorkDayOffDelete', 'permissions') && item.statusid !== 2"
            style="margin-right: 5px"
          >
            <feather-icon icon="Trash2Icon"></feather-icon>
          </b-link>
          <b-link
            :to="{ name: 'ViewHrWorkDayOff', params: { id: item.id } }"
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      ...
      HrWorkDayOffService.Delete(item.id)
        .then((res) => {
