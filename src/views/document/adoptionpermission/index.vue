    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <!-- <b-button
            variant="primary"
            :to="{ name: 'CreateAdoptionPermission' }"
          >
          ...
          <div>
            <b-button-group @click="Refresh">
              ...
              <b-button
                ...
                :variant="filter.StatusId == 17 ? 'primary' : 'outline-primary'"
                >{{ $t("ForConsideration") }}</b-button
              >
              <b-button
                @click="filter.StatusId = 19"
                :variant="filter.StatusId == 19 ? 'primary' : 'outline-primary'"
                >{{ $t("InvitedInterview") }}</b-button
              >
              <b-button
                @click="filter.StatusId = 20"
                :variant="filter.StatusId == 20 ? 'primary' : 'outline-primary'"
                >{{ $t("Returned") }}</b-button
              >
              <b-button
                @click="filter.StatusId = 21"
                :variant="filter.StatusId == 21 ? 'primary' : 'outline-primary'"
                >{{ $t("Rejectedd") }}</b-button
              >
              <b-button
                @click="filter.StatusId = 22"
                :variant="filter.StatusId == 22 ? 'primary' : 'outline-primary'"
                >{{ $t("Allowedd") }}</b-button
              >
            </b-button-group>
          </div>
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <!-- <b-link
            :to="{ name: 'EditAdoptionPermission', params: { id: item.id } }"
          ...
          <!-- <b-link
            ...
            v-if="
              $can('ChildRegistrationActDelete', 'permissions') &&
...
export default {
  ...
  methods: {
    ...
    Refresh() {
      this.isBusy = true;
      AdoptionPermissionService.GetList(
    ...
    Approve(item) {
      ...
      AdoptionPermissionService.Approve(item.id)
        .then((res) => {
    ...
    CancelApprove(item) {
      ...
      AdoptionPermissionService.CancelApproval(item.id)
        .then((res) => {
    ...
    Delete(item) {
      ...
      AdoptionPermissionService.Delete(item.id)
        .then((res) => {
