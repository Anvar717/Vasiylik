      ...
      >
        <template slot="footer" slot-scope="props">
          ...
          <div class="wizard-footer-right">
            ...
            >
              <b-spinner
                v-if="SaveLoading && props.isLastStep"
                small
              ></b-spinner>
        ...
        <tab-content :title="$t('Person')" icon="feather icon-user-plus">
        ...
        <tab-content :title="$t('Guardianship')" icon="feather icon-users">
          <b-tabs pills class="mx-1">
            <b-tab :title="$t('AdditionalInformation')">
              <b-row>
                <b-col>
        ...
        >
          <b-row>
            <b-col sm="12" md="6" lg="6">
              <div class="form-group form-row">
                <label class="col-form-label col-sm-5" for
                  >{{ $t("decisionsorg") }} <span style="color: red"> * </span>
                </label>
                <div class="col-sm-7">
                  <v-select
              ...
              <div class="form-group form-row">
                <label class="col-form-label col-sm-5" for
                  >{{ $t("decisionsdate") }} <span style="color: red"> * </span>
                </label>
                <div class="col-sm-7">
                  <custom-date-picker
              ...
              <div class="form-group form-row">
                <label class="col-form-label col-sm-5" for
                  >{{ $t("decisiontext") }} <span style="color: red"> * </span>
                </label>
                <div class="col-sm-7">
                  <v-select
        ...
        <tab-content :title="$t('sadadsad')" icon="feather icon-home">
          <b-row>
            ...
            >
              ...
              <!-- <div
                      class="form-group form-row"
                      v-if="ChildRegistrationAct.isinwaitinglist == true"
                    >
                      <label class="col-form-label col-sm-5" for>{{
                        $t("waitinglistdate")
                      }}</label>
...
export default {
  ...
  created() {
    ...
    this.show = true;
    ChildUnderGuardianshipService.Get(0)
      .then((res) => {
        this.show = false;
  ...
  methods: {
    CheckDecisions() {
      if (
        this.ChildUnderGuardianship.decisionsorgid === 0 ||
        this.ChildUnderGuardianship.decisionsorgid === null ||
        this.ChildUnderGuardianship.decisionsorgid === "" ||
        this.ChildUnderGuardianship.decisionsorgid === undefined
      ) {
        this.$makeToast(this.$t("decisionsorgidNotSelected"), "danger");
        return false;
      }
      if (
        this.ChildUnderGuardianship.decisionsdate === 0 ||
        this.ChildUnderGuardianship.decisionsdate === null ||
        this.ChildUnderGuardianship.decisionsdate === "" ||
        this.ChildUnderGuardianship.decisionsdate === undefined
      ) {
        this.$makeToast(this.$t("decisionsdateNotSelected"), "danger");
        return false;
      }
      if (
        this.ChildUnderGuardianship.decisionsnumber === 0 ||
        this.ChildUnderGuardianship.decisionsnumber === null ||
        this.ChildUnderGuardianship.decisionsnumber === "" ||
        this.ChildUnderGuardianship.decisionsnumber === undefined
      ) {
        this.$makeToast(this.$t("decisionsnumberNotSelected"), "danger");
        return false;
      }
      if (
        this.ChildUnderGuardianship.decisiontextid === 0 ||
        this.ChildUnderGuardianship.decisiontextid === null ||
        this.ChildUnderGuardianship.decisiontextid === "" ||
        this.ChildUnderGuardianship.decisiontextid === undefined
      ) {
        this.$makeToast(this.$t("decisiontextidNotSelected"), "danger");
        return false;
      }
      return true;
    },
    checkParametersInfo() {
      if (
        this.ChildUnderGuardianship.guardianshiplessreasonid === 0 ||
        this.ChildUnderGuardianship.guardianshiplessreasonid === null ||
        this.ChildUnderGuardianship.guardianshiplessreasonid === undefined ||
        this.ChildUnderGuardianship.guardianshiplessreasonid === ""
      ) {
        this.$makeToast(
          this.$t("guardianshiplessreasonidNotSelected"),
          "danger"
        );
        return false;
      }
    ...
    checkPropertytype(){
        if (
        this.ChildUnderGuardianship.propertytypeid === 0 ||
        this.ChildUnderGuardianship.propertytypeid === null ||
        this.ChildUnderGuardianship.propertytypeid === undefined ||
        this.ChildUnderGuardianship.propertytypeid === ""
      ) {
        this.$makeToast(
          this.$t("propertytypeidNotSelected"),
          "danger"
        );
        return false;
      }
    ...
    ClearIsinwaitinglist() {
      ...
      // this.ChildUnderGuardianship.isinwaitinglist = false;
    },
    ClearNeedproperty() {
      this.ChildUnderGuardianship.isinwaitinglist = false;
      this.ClearIsinwaitinglist();
    },
    ...
    SaveData() {
      ...
      this.ChildUnderGuardianship.Children.isstudent = true;
      this.ChildUnderGuardianship.Guardian.isstudent = false;
