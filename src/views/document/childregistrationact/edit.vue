  ...
  <b-overlay :show="show">
      ...
      <b-col>
        <b-card>
          <b-tabs pills v-model="tabIndex">
            <b-tab active :title="$t('AdditionalInformation')">
              <b-row>
                <b-col>
                  <!-- <children-list
              ...
              <b-row>
                <b-col sm="12" md="6" lg="6">
                  ...
                  <!-- <div class="form-group form-row">
                    ...
                    <div class="col-sm-7">
                      <b-form-input
                        :placeholder="$t('childcharacter')"
                        v-model="tabrow.childcharacter"
                      />
                    </div>
                  </div> -->
                    <div class="form-group form-row">
          ...
          <b-row>
            ...
            <b-tab  :title="$t('RegistrationActTables')">
              <b-row class="mb-2">
                <b-col class="text-right">
                  <b-button
                    @click="OpenModalAct"
            ...
            <b-tab :title="$t('ChildrenActFiles')">
              <b-row>
    ...
    >
      <children-list
        ...
        @DblClicked="AddPerson"
      ></children-list>
      <b-row>
        <b-col class="text-center">
          <b-button @click="PersonModal = false" class="mr-1" variant="danger">
            {{ $t("close") }}
          </b-button>
          <b-button @click="AddPerson(personvalue)" variant="success">
            {{ $t("Save") }}
          </b-button>
        </b-col>
      </b-row>
...
export default {
  ...
  data() {
    return {
      ...
      DeleteLoading: false,
      tabIndex: 0,
      isChangePerson : false
    };
  },
  created() {
    this.lang = localStorage.getItem("locale") || "ru";
    this.show = true;
    ChildRegistrationActService.Get(this.$route.params.id)
      .then((res) => {
        this.show = false;
        ...
        this.Person = this.ChildRegistrationAct.person;
        this.tabrow3 = this.ChildRegistrationAct.RegistrationActTables;
      })
      .catch((error) => {
  ...
  methods: {
    ...
    BinddValue(value) {
      this.ChildRegistrationAct.decisionsdate = value;
    },
    ...
    AddPerson(data) {
      ...
      this.ChildRegistrationAct.personid = data.id;
      this.ChildRegistrationAct.personname = data.fullname;
    },
    SelectItem(data) {
    ...
    SaveData() {
      ...
      console.log(this.isChangePerson)
      // if(!this.isChangePerson){
        this.ChildRegistrationAct.person = this.Person
      // }
      // this.ChildRegistrationAct.person = this.Person
