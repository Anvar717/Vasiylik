<template>
  <b-overlay :show="show">
      ...
      <b-row>
        <b-col sm="12" md="12" lg="3">
          ...
          <b-form-input
            ...
            v-model="ChildUnderGuardExpulsion.docnumber"
          />
        </b-col>
        <b-col sm="12" md="12" lg="3">
          ...
          <b-form-input
            ...
            v-model="ChildUnderGuardExpulsion.docdate"
          />
        </b-col>
        <b-col sm="12" md="12" lg="6">
          ...
          <b-form-textarea
            ...
            v-model="ChildUnderGuardExpulsion.detailinfo"
          />
        </b-col>
      </b-row>
    </b-card>
    <b-card>
      <b-row>
        <b-col sm="12" md="12" lg="3">
          ...
          <b-form-checkbox
            switch
            v-model="ChildUnderGuardExpulsion.hasdecision"
          />
        </b-col>
        <b-col
          v-if="ChildUnderGuardExpulsion.hasdecision == true"
          sm="12"
          md="12"
          lg="3"
        >
          ...
          <b-form-input
            ...
            v-model="ChildUnderGuardExpulsion.decisionsnumber"
          />
        </b-col>
        <b-col
          v-if="ChildUnderGuardExpulsion.hasdecision == true"
        ...
        >
          ...
          <v-select
            ...
            label="name"
            v-model="ChildUnderGuardExpulsion.decisionsorgid"
          ></v-select>
        </b-col>
        <b-col
          v-if="ChildUnderGuardExpulsion.hasdecision == true"
        ...
        >
          ...
          <custom-date-picker
            v-model="ChildUnderGuardExpulsion.decisionsdate"
      ...
      <b-row>
        <b-col sm="12" md="12" lg="3">
          ...
          <v-select
            ...
            :placeholder="$t('ChooseBelow')"
            label="name"
            v-model="ChildUnderGuardExpulsion.childexpulsiontypeid"
          ></v-select>
        </b-col>
        <b-col sm="12" md="12" lg="3">
          ...
          <b-input-group>
            <b-form-input
              v-model="ChildUnderGuardExpulsion.personname"
              disabled
            ></b-form-input>
    ...
    <b-card v-if="ChildUnderGuardExpulsion.childexpulsiontypeid != 11">
      <b-row>
...
export default {
  ...
  created() {
    ...
    this.show = true;
    ChildUnderGuardExpulsionService.Get(this.$route.params.id)
      .then((res) => {
        this.show = false;
  ...
  methods: {
    ...
    AddDataGuardian(data) {
      this.ChildUnderGuardExpulsion.personid = data.personid;
      this.ChildUnderGuardExpulsion.personname = data.personname;
      this.ChildUnderGuardExpulsion.childunderguardianshipid =
    ...
    DecisionsdateValue(value) {
      this.ChildUnderGuardExpulsion.decisionsdate = value;
    },
    Delete(item) {
    ...
    ChangeFile(data) {
      ...
      AdmImageService.AttachImage(formData)
        .then((res) => {
          this.show = false;
          this.ChildUnderGuardExpulsion.File.push({
            id: 0,
            ownerid: 0,
            ordernumber: 0,
    ...
    SaveData() {
      ChildUnderGuardExpulsionService.Update(this.ChildUnderGuardExpulsion)
        .then((res) => {
