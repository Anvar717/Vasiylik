    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditHRTimeSheet', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditHRTimeSheet', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            v-if="$can('HRTimesheetEdit', 'permissions') &&  item.statusid !== 2"
          ...
          <b-link
            ...
            v-if="$can('HRTimesheetDelete', 'permissions') &&  item.statusid !== 2"
            style="margin-right: 5px"
          >
            <feather-icon icon="Trash2Icon"></feather-icon>
          </b-link>
          <b-link
            :to="{ name: 'ViewHRTimeSheet', params: { id: item.id } }"
