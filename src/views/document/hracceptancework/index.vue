    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditHrAcceptanceWork', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditHrAcceptanceWork', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            v-if="$can('HrAcceptanceWorkEdit', 'permissions') && item.statusid !== 2"
          ...
          <b-link
            ...
            v-if=" $can('HrAcceptanceWorkDelete', 'permissions') && item.statusid !== 2"
            style="margin-right: 5px"
          >
            <feather-icon icon="Trash2Icon"></feather-icon>
          </b-link>
          <b-link
            :to="{ name: 'ViewHrAcceptanceWork', params: { id: item.id } }"
...
export default {
  ...
  methods: {
    ...
    Refresh() {
      this.isBusy = true;
      HrAcceptanceWorkService.GetList(
    ...
    Delete(item) {
      ...
      HrAcceptanceWorkService.Delete(item.id)
        .then((res) => {
