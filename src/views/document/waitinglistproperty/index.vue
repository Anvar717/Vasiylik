    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditWaitingListProperty', params: { id: 0 } }"
          >
        ...
        <div class="text-center">
          <b-link
            ...
            v-if="
              ...
              $can('WaitingListPropertyEdit', 'permissions')
            "
          >
          ...
          <b-link
            ...
            v-if="
              $can('WaitingListPropertyDelete', 'permissions') &&
              item.statusname !== 'Утвержден'
            "
          >
...
export default {
  ...
  methods: {
    ...
    Refresh() {
      this.isBusy = true;
      WaitingListPropertyService.GetList(
        this.filter.Search,
        this.filter.Sort,
        this.filter.Order,
    ...
    Approve(item) {
      ...
      WaitingListPropertyService.Approve(item.id)
        .then((res) => {
    ...
    CancelApprove(item) {
      ...
      WaitingListPropertyService.CancelApproval(item.id)
        .then((res) => {
    ...
    Delete(item) {
      ...
      WaitingListPropertyService.Delete(item.id)
        .then((res) => {
