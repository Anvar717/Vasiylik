      ...
      <b-row>
          ...
          <div class="form-group form-row">
            ...
            <div class="col-sm-7">
              <b-form-input
                ...
                v-model="HREmpSickLeave.docnumber"
              />
            </div>
          </div>
        </b-col>
        <b-col sm="12" md="4" lg="4">
          <div class="form-group form-row">
            ...
            <div class="col-sm-7">
              <custom-date-picker
                v-model="HREmpSickLeave.docdate"
                @keyup="DocdateValue"
                format="DD.MM.YYYY"
                type="date"
                :clearable="false"
          ...
          <div class="form-group form-row">
            ...
            <div class="col-sm-7">
              <b-form-input
                ...
                v-model="HREmpSickLeave.detailinfo"
              />
            </div>
          </div>
        </b-col>
        ...
        <b-row>
          <b-col sm="12" md="8" lg="8">
            ...
            <div class="form-group form-row">
              ...
              <div class="col-sm-7">
                <b-form-input
                  :placeholder="$t('employeeenrolment')"
            ...
            <div class="form-group form-row">
              ...
              <div class="col-sm-7">
                <custom-date-picker
                  v-model="tabrow.givendate"
                  @keyup="GivendateValue"
                  format="DD.MM.YYYY"
                  type="date"
                  :clearable="false"
            ...
            <div class="form-group form-row">
              ...
              <div class="col-sm-7">
                <b-form-input
                  ...
                  v-model="tabrow.givenorganization"
                />
              </div>
            </div>
            <div class="form-group form-row">
            ...
            <div class="form-group form-row">
              ...
              <div class="col-sm-7">
                <v-select
                  ...
                  :placeholder="$t('ChooseBelow')"
                  label="name"
                  v-model="tabrow.calcperc"
                ></v-select>
              </div>
            </div>
            <div v-if="gender == 'Женский'" class="form-group form-row">
              <label
                class="col-form-label col-sm-5 d-flex align-items-center"
                for
                >{{ $t("ismaternityleave") }}</label
              >
              <div class="col-sm-7">
                <b-form-checkbox
                  v-model="tabrow.ismaternityleave"
                  name="check-button1"
                  switch
                >
                </b-form-checkbox>
          ...
          <b-col  sm="12" md="4" lg="4">
             <div class="form-group form-row">
              <label class="col-form-label col-sm-5" for></label>
              <div class="col-sm-7">
              </div>
            </div>
            <div block style="margin-top:39px">
              <b-button
                @click="Openperson"
                :disabled="!tabrow.departmentid"
                variant="primary"
...
import HREmpSickLeaveService from "@/services/document/hrempsickleave.service";
...
export default {
  ...
  data() {
    return {
      ...
      gender: "",
      PercentList: [{ name: 60 }, { name: 80 }, { name: 100 }],
      lang: "ru",
      config: {
        dateFormat: "d.m.Y",
      },
  ...
  created() {
    ...
    this.show = true;
    HREmpSickLeaveService.Get(this.$route.params.id)
      .then((res) => {
        this.show = false;
        this.HREmpSickLeave = res.data;
      })
      .catch((error) => {
  ...
  methods: {
    GetpersonPersondata() {
      ...
      EmployeeManageService.GetEmployeeListForComponent(
        (this.filter.OnDate = this.HREmpSickLeave.docdate),
    ...
    AddPersonData() {
      ...
      this.tabrow.employeeenrolmentid = this.selected[0].employeeenrolmentid;
    ...
    PersonChange(item) {
      ...
      this.tabrow.employeeenrolmentid = item.employeeenrolmentid;
    ...
    AddData() {
      ...
      //     ? this.PercentList.filter(
      //         (item) => this.tabrow.calcperc === item.id
      //       )[0].name
      //     : "";
      if (this.editedIndex > -1) {
        Object.assign(
          this.HREmpSickLeave.Tables[this.editedIndex],
          this.tabrow
        );
      } else {
        this.HREmpSickLeave.Tables.push(this.tabrow);
      }
    ...
    GivendateValue(value) {
      this.tabrow.givendate = value;
    },
    DocdateValue(value) {
      this.HREmpSickLeave.docdate = value;
    },
    ...
    SaveData() {
      HREmpSickLeaveService.Update(this.HREmpSickLeave).then((res) => {
        this.$makeToast(this.$t("SaveSuccess"), "success");
        this.$router.push({ name: `hrempsickleave` });
      });
      console.log(this.HREmpSickLeave).catch((err) => {
