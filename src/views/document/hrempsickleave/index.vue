    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditHREmpSickLeave', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditHREmpSickLeave', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            v-if="$can('HREmpSickLeaveEdit', 'permissions') && item.statusid !== 2"
          ...
          <b-link
            ...
            v-if="$can('HREmpSickLeaveDelete', 'permissions') && item.statusid !== 2"
             style="margin-right: 5px"
          >
            <feather-icon icon="Trash2Icon"></feather-icon>
          </b-link>
          <b-link
            :to="{ name: 'ViewHREmpSickLeave', params: { id: item.id } }"
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      ...
      HREmpSickLeaveService.Delete(item.id)
        .then((res) => {
