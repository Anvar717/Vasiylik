    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditChildRegExpulsion', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditChildRegExpulsion', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
            v-if="$can('ChildRegExpulsionEdit' , 'permissions') && item.statusid != 2"
          >
          ...
          <b-link
            ...
            v-b-tooltip.hover.top="$t('Delete')"
             style="margin-right: 5px"
            v-if="$can('ChildRegExpulsionDelete' , 'permissions') && item.statusid != 2"
          >
            <feather-icon icon="Trash2Icon"></feather-icon>
          </b-link>
            <b-link
            :to="{ name: 'ViewChildRegExpulsion', params: { id: item.id } }"
...
export default {
  ...
  methods: {
    ...
    Refresh(){
        this.isBusy = true;
        ChildRegExpulsionService.GetList(
    ...
    Delete(item) {
      ...
      ChildRegExpulsionService.Delete(item.id)
        .then((res) => {
