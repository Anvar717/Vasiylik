  ...
  <b-card no-body>
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <!-- <b-button
            variant="primary"
            :to="{ name: 'EditHousingQueue', params: { id: 0 } }"
          >
    ...
    >
      <template #cell(statusname)="{ item }">
        <b-badge
          :variant="item.statusid == 58 ? 'light-success' : 
          item.statusid == 57 ? 'light-danger' : item.statusid == 48 ? 'light-danger' : item.statusid == 49 ? 'light-success' : 'light-primary'"
        >
          {{ item.statusname }}
        </b-badge>
      </template>
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <!-- <b-link
            :to="{ name: 'EditHousingQueue', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
            v-if="$can('HousingQueueEdit' , 'permissions') && item.statusid != 2"
          >
          ...
          <!-- <b-link
            ...
            v-b-tooltip.hover.top="$t('Delete')"
             style="margin-right: 5px"
            v-if="$can('HousingQueueDelete' , 'permissions') && item.statusid != 2"
          >
            <feather-icon icon="Trash2Icon"></feather-icon>
          </b-link> -->
            <b-link
            :to="{ name: 'ViewCourtApplication', params: { id: item.id }}"
...
export default {
  ...
  methods: {
    ...
    Refresh(){
        this.isBusy = true;
        CourtApplicationService.GetList(
