    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditHigherEduClassifier', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditHigherEduClassifier', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            v-if="$can('HigherEduClassifierEdit', 'permissions')"
          ...
          <b-link
            ...
            v-if="$can('HigherEduClassifierDelete', 'permissions')"
          >
...
export default {
  ...
  methods: {
    ...
    Refresh() {
      this.isBusy = true;
      HigherEduClassifierService.GetList(
        this.filter.Search,
    ...
    Delete(item) {
      ...
      HigherEduClassifierService.Delete(item.id)
        .then((res) => {
