      ...
      <b-row>
        <b-col sm="12" md="6" lg="6">
          ...
          <div div class="form-group form-row mb-0">
            ...
            <div class="col-sm-7">
              <b-form-checkbox
                v-model="HigherEduClassifier.isgroup"
                name="check-button1"
                switch
              >
              </b-form-checkbox>
...
import HigherEduClassifierService from "@/services/info/highereduclassifier.service";
...
export default {
  ...
  created() {
    ...
    this.show = true;
    HigherEduClassifierService.Get(this.$route.params.id)
      .then((res) => {
        this.show = false;
        this.HigherEduClassifier = res.data;
      })
      .catch((error) => {
  ...
  methods: {
    ...
    AddTranslate() {
      ...
      if (
        this.HigherEduClassifier.Translates.filter(
          (item) =>
      ...
      this.HigherEduClassifier.Translates.push(this.TranslateItem);
    ...
    GetTranslateItems(columnname) {
      this.TranslateItems = this.HigherEduClassifier.Translates.filter(
        (item) => item.columnname == columnname
      );
    },
    SaveData() {
      HigherEduClassifierService.Update(this.HigherEduClassifier)
        .then((res) => {
          this.$makeToast(this.$t("SaveSuccess"), "success");
          this.$router.push({ name: `highereduclassifier` });
        })
        .catch((err) => {
