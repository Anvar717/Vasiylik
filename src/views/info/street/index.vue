    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditStreet', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditStreet', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
            v-if="$can('StreetEdit' , 'permissions')"
          >
          ...
          <b-link
            ...
            v-b-tooltip.hover.top="$t('Delete')"
             v-if="$can('StreetDelete' , 'permissions')"
          >
