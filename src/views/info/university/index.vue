    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditUniversity', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditUniversity', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
            v-if="$can('UniversityEdit', 'permissions')"
          >
          ...
          <b-link
            ...
            v-if="$can('UniversityDelete', 'permissions')"
          >
...
import UniversityService from "@/services/info/university.service";
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      ...
      UniversityService.Delete(item.id)
        .then((res) => {
