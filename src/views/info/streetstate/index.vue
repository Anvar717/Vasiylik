    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditStreetState', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditStreetState', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
            v-if="$can('StreetStateEdit', 'permissions')"
          >
          ...
          <b-link
            ...
            v-if="$can('StreetStateDelete', 'permissions')"
          >
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      ...
      StreetStateService.Delete(item.id)
        .then((res) => {
