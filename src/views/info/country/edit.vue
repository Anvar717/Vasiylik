      ...
      <b-col sm="12" md="6" lg="6">
        <b-card>
          ...
          <div class="form-group form-row">
            ...
            <div class="col-sm-7">
              <b-form-input
                :placeholder="$t('stringcode')"
                v-model="Country.Stringcode"
              />
            </div>
          </div>
          <div class="form-group form-row">
...
export default {
  ...
  methods: {
    ...
    AddTranslate(){
      ...
      if(this.Country.Translates.filter(item => item.languageid === this.TranslateItem.languageid && item.columnname == this.TranslateItem.columnname).length > 0){
        this.$makeToast(this.$t('AlreadySelectLang'),'danger')
        return false
      }
      this.Country.Translates.push(this.TranslateItem)
    ...
    GetTranslateItems(columnname){
      this.TranslateItems = this.Country.Translates.filter(item => item.columnname == columnname)
    },
    // check(){
    //     if (
