    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditDecisionText', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditDecisionText', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
            v-if="$can('DecisionTextEdit' , 'permissions')"
          >
          ...
          <b-link
            ...
            v-if="$can('DecisionTextDelete' , 'permissions')"
          >
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      ...
      DecisionTextService.Delete(item.id)
        .then((res) => {
