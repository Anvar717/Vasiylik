      ...
      <b-row>
        <b-col sm="12" md="6" lg="6">
          <div class="form-group form-row">
            ...
            <div class="col-sm-7">
              <b-form-input :placeholder="$t('code')" v-model="DecisionText.code" />
            </div>
          </div>
          <div class="form-group form-row">
            ...
            <div class="col-sm-7">
              <b-form-input
                ...
                v-model="DecisionText.shortname"
              />
            </div>
          </div>
          <div class="form-group form-row">
...
export default {
  ...
  created() {
    ...
    this.show = true;
    DecisionTextService.Get(this.$route.params.id)
      .then((res) => {
        this.show = false;
        this.DecisionText = res.data;
      })
      .catch((error) => {
  ...
  methods: {
    ...
    // },
    SaveData() {
      DecisionTextService.Update(this.DecisionText)
        .then((res) => {
          this.$makeToast(this.$t("SaveSuccess"), "success");
          this.$router.push({ name: `decisiontext` });
        })
        .catch((err) => {
