  ...
  <b-card no-body>
    ...
    >
      ...
      <template #cell(isgroup)="{ item }">
        <b-badge :variant="item.isgroup ? 'light-success' : 'light-danger'">
...
import SchoolUniformDesignTypeService from "@/services/info/schooluniformdesigntype.service";
...
export default {
  ...
  methods: {
    ...
    Refresh() {
      this.isBusy = true;
      SchoolUniformDesignTypeService.GetList(
        this.filter.Search,
        this.filter.Sort,
        this.filter.Order,
