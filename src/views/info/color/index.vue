    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditColor', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
            v-if="$can('ColorEdit' , 'permissions')"
          >
          ...
          <b-link
            ...
            v-if="$can('ColorDelete' , 'permissions')"
          >
