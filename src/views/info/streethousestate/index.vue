    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditStreetHouseState', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditStreetHouseState', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
            v-if="$can('StreetHouseStateEdit' , 'permissions')"
          >
          ...
          <b-link
            ...
            v-b-tooltip.hover.top="$t('Delete')"
             v-if="$can('StreetHouseStateDelete' , 'permissions')"
          >
...
export default {
  ...
  methods: {
    ...
    Refresh() {
      this.isBusy = true;
      StreetHouseStateService.GetList(
        this.filter.Search,
        this.filter.Sort,
        this.filter.Order,
    ...
    Delete(item) {
      ...
      StreetHouseStateService.Delete(item.id)
        .then((res) => {
