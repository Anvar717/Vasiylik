    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditChildMeasuresTakenForAdoption', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditChildMeasuresTakenForAdoption', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
            v-if="$can('ChildMeasuresTakenForAdoptionEdit' , 'permissions')"
          >
          ...
          <b-link
            ...
            v-if="$can('ChildMeasuresTakenForAdoptionDelete' , 'permissions')"
          >
...
export default {
  ...
  methods: {
    ...
    Refresh() {
      this.isBusy = true;
      ChildMeasuresTakenForAdoptionService.GetList(
        this.filter.Search,
        this.filter.Sort,
        this.filter.Order,
    ...
    Delete(item) {
      ...
      ChildMeasuresTakenForAdoptionService.Delete(item.id)
        .then((res) => {
