      ...
      <b-row>
        <b-col sm="12" md="6" lg="6">
          <div class="form-group form-row">
            ...
            <div class="col-sm-7">
              <b-form-input :placeholder="$t('code')" v-model="ChildMeasuresTakenForAdoption.code" />
            </div>
          </div>
          <div class="form-group form-row">
            ...
            <div class="col-sm-7">
                ...
                <b-form-input
                  ...
                  v-model="ChildMeasuresTakenForAdoption.shortname"
                />
          ...
          <div class="form-group form-row">
            ...
            <div class="col-sm-7">
                ...
                <b-form-input
                  ...
                  v-model="ChildMeasuresTakenForAdoption.fullname"
                />
                <b-input-group-append>
          ...
          <div div class="form-group form-row mb-0">
            ...
            <div class="col-sm-7">
              <b-form-checkbox
                v-model="ChildMeasuresTakenForAdoption.iseye"
                name="check-button1"
                switch
              >
              </b-form-checkbox>
          ...
          <div class="form-group form-row">
            ...
            <div class="col-sm-7">
              <v-select
                ...
                label="name"
                v-model="ChildMeasuresTakenForAdoption.stateid"
              ></v-select>
            </div>
          </div>
        </b-col>
...
export default {
  ...
  created() {
    ...
    this.show = true;
    ChildMeasuresTakenForAdoptionService.Get(this.$route.params.id)
      .then((res) => {
        this.show = false;
        this.ChildMeasuresTakenForAdoption = res.data;
      })
      .catch((error) => {
  ...
  methods: {
    ...
    clearLangTable(columnname){
     ...
     AddTranslate(){
      ...
      console.log(this.ChildMeasuresTakenForAdoption)
      if(this.ChildMeasuresTakenForAdoption.Translates.filter(item => item.languageid === this.TranslateItem.languageid && item.columnname == this.TranslateItem.columnname).length > 0){
        this.$makeToast(this.$t('AlreadySelectLang'),'danger')
        return false
      }
      this.ChildMeasuresTakenForAdoption.Translates.push(this.TranslateItem)
   ...
   OpenTranslateModal(columnname){
     ...
     GetTranslateItems(columnname){
      this.TranslateItems = this.ChildMeasuresTakenForAdoption.Translates.filter(item => item.columnname == columnname)
    },
    // check(){
    //     if (
    ...
    // },
    SaveData() {
      ChildMeasuresTakenForAdoptionService.Update(this.ChildMeasuresTakenForAdoption)
        .then((res) => {
          this.$makeToast(this.$t("SaveSuccess"), "success");
          this.$router.push({ name: `childmeasurestakenforadoption` });
        })
        .catch((err) => {
