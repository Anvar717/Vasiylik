    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditKinshipDegree', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditKinshipDegree', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
            v-if="$can('KinshipDegreeEdit' , 'permissions' )"
          >
          ...
          <b-link
            ...
            v-if="$can('KinshipDegreeDelete' , 'permissions' )"
          >
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      ...
      KinshipDegreeService.Delete(item.id)
        .then((res) => {
