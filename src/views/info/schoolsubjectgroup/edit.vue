          ...
          <div class="form-group form-row">
            ...
            <div class="col-sm-7">
              <b-form-input
                ...
                v-model="SchoolSubjectGroup.shortname"
              />
            </div>
          </div>
          <div class="form-group form-row">
            ...
            <div class="col-sm-7">
              <b-form-input
                ...
                v-model="SchoolSubjectGroup.fullname"
              />
            </div>
          </div>
        </b-card>
        ...
        <b-card>
          <div class="form-group form-row">
            ...
            <div class="col-sm-7">
              <b-form-input
                :placeholder="$t('code')"
                v-model="SchoolSubjectGroup.code"
              />
            </div>
          </div>
          <div class="form-group form-row">
            ...
            <div class="col-sm-7">
              <v-select
                ...
                label="name"
                v-model="SchoolSubjectGroup.stateid"
              ></v-select>
            </div>
          </div>
        </b-card>
...
import SchoolSubjectGroupService from "@/services/info/schoolsubjectgroup.service";
...
export default {
  ...
  created() {
    ...
    this.show = true;
    SchoolSubjectGroupService.Get(this.$route.params.id)
      .then((res) => {
        this.show = false;
        this.SchoolSubjectGroup = res.data;
      })
      .catch((error) => {
  ...
  methods: {
    ...
    // },
    SaveData() {
      SchoolSubjectGroupService.Update(this.SchoolSubjectGroup)
        .then((res) => {
          this.$makeToast(this.$t("SaveSuccess"), "success");
          this.$router.push({ name: `schoolsubjectgroup` });
        })
        .catch((err) => {
