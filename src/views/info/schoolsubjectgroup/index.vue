    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditSchoolSubjectGroup', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditSchoolSubjectGroup', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
            v-if="$can('SchoolSubjectGroupEdit', 'permissions')"
          >
          ...
          <b-link
            ...
            v-if="$can('SchoolSubjectGroupDelete', 'permissions')"
          >
...
export default {
  ...
  methods: {
    ...
    Refresh() {
      this.isBusy = true;
      SchoolSubjectGroupService.GetList(
        this.filter.Search,
        this.filter.Sort,
        this.filter.Order,
    ...
    Delete(item) {
      ...
      SchoolSubjectGroupService.Delete(item.id)
        .then((res) => {
