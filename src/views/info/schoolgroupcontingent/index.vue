    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditSchoolGroupContingent', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditSchoolGroupContingent', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
            v-if="$can('SchoolGroupContingentEdit', 'permissions')"
          >
          ...
          <b-link
            ...
            v-if="$can('SchoolGroupContingentDelete', 'permissions')"
          >
...
export default {
  ...
  methods: {
    ...
    Refresh() {
      this.isBusy = true;
      SchoolGroupContingentService.GetList(
        this.filter.Search,
        this.filter.Sort,
        this.filter.Order,
    ...
    Delete(item) {
      ...
      SchoolGroupContingentService.Delete(item.id)
        .then((res) => {
