    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditChildCharacter', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditChildCharacter', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
            v-if="$can('ChildCharacterEdit' , 'permissions')"
          >
          ...
          <b-link
            ...
            v-if="$can('ChildCharacterDelete' , 'permissions')"
          >
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      ...
      ChildCharacterService.Delete(item.id)
        .then((res) => {
