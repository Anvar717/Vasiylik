      ...
      <b-row>
        <b-col sm="12" md="6" lg="6">
          <div class="form-group form-row">
            ...
            <div class="col-sm-7">
              <b-form-input :placeholder="$t('code')" v-model="ChildCharacter.code" />
            </div>
          </div>
          <div class="form-group form-row">
            ...
            <div class="col-sm-7">
              <b-input-group>
                <b-form-input
                  ...
                  v-model="ChildCharacter.shortname"
                />
            ...
            <div class="col-sm-7">
             <b-input-group>
                <b-form-input
                  ...
                  v-model="ChildCharacter.fullname"
                />
                <b-input-group-append>
          ...
          <div class="form-group form-row">
            ...
            <div class="col-sm-7">
              <v-select
                ...
                label="name"
                v-model="ChildCharacter.stateid"
              ></v-select>
            </div>
          </div>
        </b-col>
...
export default {
  ...
  created() {
    ...
    this.show = true;
    ChildCharacterService.Get(this.$route.params.id)
      .then((res) => {
        this.show = false;
        this.ChildCharacter = res.data;
      })
      .catch((error) => {
  ...
  methods: {
    ...
    clearLangTable(columnname){
     ...
     AddTranslate(){
      ...
      if(this.ChildCharacter.Translates.filter(item => item.languageid === this.TranslateItem.languageid && item.columnname == this.TranslateItem.columnname).length > 0){
        this.$makeToast(this.$t('AlreadySelectLang'),'danger')
        return false
      }
      this.ChildCharacter.Translates.push(this.TranslateItem)
   ...
   OpenTranslateModal(columnname){
     ...
     GetTranslateItems(columnname){
      this.TranslateItems = this.ChildCharacter.Translates.filter(item => item.columnname == columnname)
    },
    // check(){
    //     if (
    ...
    // },
    SaveData() {
      ChildCharacterService.Update(this.ChildCharacter)
        .then((res) => {
          this.$makeToast(this.$t("SaveSuccess"), "success");
          this.$router.push({ name: `childcharacter` });
        })
        .catch((err) => {
