    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditPositionClassification', params: { id: 0 } }"
          >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            ...
            v-if="$can('PositionClassificationEdit', 'permissions')"
          >
          ...
          <b-link
            ...
            v-if="$can('PositionClassificationDelete', 'permissions')"
          >
  ...
  data() {
    return {
      ...
      fields: [
        ...
        {
          key: "educationdirection",
          label: this.$t("educationdirection"),
          thClass: "text-center",
          tdClass: "text-center",
          sortable: true,
        },
        ...
        {
          key: "qualificationrank",
          label: this.$t("qualificationrank"),
          thClass: "text-center",
          tdClass: "text-center",
          sortable: true,
        },
