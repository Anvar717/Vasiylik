  ...
  <b-card no-body>
    ...
    >
      ...
      <template #cell(isgroup)="{ item }">
        <b-badge
          :variant="item.isgroup ? 'light-success' : 'light-danger'"
        >
...
import OlympiadWinnerTypeService from "@/services/info/olympiadwinnertype.service";
...
export default {
  ...
  methods: {
    ...
    Refresh() {
      this.isBusy = true;
      OlympiadWinnerTypeService.GetList(
        this.filter.Search,
        this.filter.Sort,
        this.filter.Order,
