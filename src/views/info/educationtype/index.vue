    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditEducationType', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditEducationType', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
            v-if="$can('EducationTypeEdit', 'permissions')"
          >
          ...
          <b-link
            ...
            v-if="$can('EducationTypeDelete', 'permissions')"
          >
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      ...
      EducationTypeService.Delete(item.id)
        .then((res) => {
