    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditDecisionsOrg', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditDecisionsOrg', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
            v-if="$can('DecisionsOrgEdit', 'permissions')"
          >
          ...
          <b-link
            ...
            v-if="$can('DecisionsOrgDelete', 'permissions')"
          >
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      ...
      DecisionsOrgService.Delete(item.id)
        .then((res) => {
