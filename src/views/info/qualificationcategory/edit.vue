  ...
  <b-overlay :show="show">
    <b-card>
      <b-row>
        ...
        <b-col sm="12" md="6" lg="6">
          <div class="form-group form-row">
            <label class="col-form-label col-sm-5" for>{{ $t("detailinfo") }}</label>
            <div class="col-sm-7">
              <b-form-input
...
export default {
  ...
  created() {
    ...
    QualificationCategoryService.Get(this.$route.params.id)
      .then((res) => {
        this.show = false;
        this.QualificationCategory = res.data;
      })
      .catch((error) => {
  ...
  methods: {
    ...
    AddTranslate() {
      ...
      if (
        this.QualificationCategory.Translates.filter(
          (item) =>
      ...
      this.QualificationCategory.Translates.push(this.TranslateItem);
    ...
    GetTranslateItems(columnname) {
      this.TranslateItems = this.QualificationCategory.Translates.filter(
        (item) => item.columnname == columnname
      );
    },
    SaveData() {
      QualificationCategoryService.Update(this.QualificationCategory)
        .then((res) => {
