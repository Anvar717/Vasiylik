    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditQualificationCategory', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditQualificationCategory', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
            v-if="$can('QualificationCategoryEdit', 'permissions')"
          >
          ...
          <b-link
            ...
            v-if="$can('QualificationCategoryDelete', 'permissions')"
          >
...
export default {
  ...
  methods: {
    ...
    Refresh() {
      this.isBusy = true;
      QualificationCategoryService.GetList(
        this.filter.Search,
