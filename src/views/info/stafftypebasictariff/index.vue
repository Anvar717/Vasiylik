    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditStaffTypeBasicTariff', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditStaffTypeBasicTariff', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
            v-if="$can('StaffTypeBasicTariffEdit', 'permissions')"
          >
          ...
          <b-link
            ...
            v-if="$can('StaffTypeBasicTariffDelete', 'permissions')"
          >
...
export default {
  ...
  methods: {
    ...
    Refresh() {
      this.isBusy = true;
      StaffTypeBasicTariffService.GetList(
        this.filter.Search,
