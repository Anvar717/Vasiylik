          ...
          <!-- <div class="form-group form-row">
            ...
            <div class="col-sm-7">
              <b-form-input
                ...
                v-model="StreetHouse.streettype"
              />
            </div>
          </div> -->
          <div class="form-group form-row">
...
export default {
  ...
  created() {
    ...
    this.show = true;
    StreetHouseService.Get(this.$route.params.id)
      .then((res) => {
        this.show = false;
        this.StreetHouse = res.data;
      })
      .catch((error) => {
  ...
  methods: {
    ...
    // },
    SaveData() {
      StreetHouseService.Update(this.StreetHouse)
        .then((res) => {
          this.$makeToast(this.$t("SaveSuccess"), "success");
          this.$router.push({ name: `streethouse` });
        })
        .catch((err) => {
