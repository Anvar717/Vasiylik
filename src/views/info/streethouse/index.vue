    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditStreetHouse', params: { id: 0 } }"
          >
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            :to="{ name: 'EditStreetHouse', params: { id: item.id } }"
            v-b-tooltip.hover.top="$t('Edit')"
            style="margin-right: 5px"
             v-if="$can('StreetHouseEdit' , 'permissions')"
          >
          ...
          <b-link
            ...
            v-if="$can('StreetHouseDelete' , 'permissions')"
          >
      ...
      <template #cell(withflats)="{ item }">
        <b-badge :variant="item.withflats ? 'light-success' : 'light-danger'">
          {{ item.withflats ? $t("yes") : $t("no") }}
        </b-badge>
      </template>
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      ...
      StreetHouseService.Delete(item.id)
        .then((res) => {
