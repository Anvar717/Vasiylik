    ...
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          <b-button
            variant="primary"
            :to="{ name: 'EditGuardianshiplessReason', params: { id: 0 } }"
          >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link
            ...
            v-if="$can('GuardianshiplessReasonEdit', 'permissions')"
          >
          ...
          <b-link
            ...
            v-if="$can('GuardianshiplessReasonDelete', 'permissions')"
          >
...
export default {
  ...
  methods: {
    ...
    Refresh() {
      this.isBusy = true;
      GuardianshiplessReasonService.GetList(
        this.filter.Search,
        this.filter.Sort,
        this.filter.Order,
    ...
    Delete(item) {
      ...
      GuardianshiplessReasonService.Delete(item.id)
        .then((res) => {
