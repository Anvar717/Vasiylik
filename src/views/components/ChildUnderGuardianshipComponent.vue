    ...
    <b-row>
      <b-col sm="12" md="12">
        <b-table
          ...
          @row-dblclicked="ChildGuardianshipChange"
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        {
          key: "childunderguardianshipdocdate",
          label: this.$t("childunderguardianshipdocdate"),
          thClass: "text-center",
          tdClass: "text-center",
          sortable: true,
        },
  ...
  methods: {
    ...
    Refresh() {
      ...
      ReportService.ChildUnderGuardianshipListForSelect(
        this.filter.Search,
